= NUSModsCloud {<img src="https://travis-ci.org/nusmodifications/nusmods-cloud.svg?branch=master" alt="Build Status" />}[https://travis-ci.org/nusmodifications/nusmods-cloud]
...
2. Implement the new feature / bug fix
3. Add the spec of your feature in specs/, make sure all of them passes
4. Create a PR.
