...
RSpec.describe FriendshipsController, type: :controller do
  ...
  describe 'POST #create' do
    ...
    context 'when user is authenticated' do
      ...
      context 'when requested friend is not in db' do
      ...
      context 'when requested friend is already a friend of the user' do
      ...
      context 'when requested a requested friend' do
        it 'returns 400 bad request' do
          expect(User).to receive(:find_by_nusnet_id).and_return(user2)
          allow(Friendship).to receive_message_chain(:where, :first)
      ...
      context 'when requested a incoming friend' do
      ...
      context 'when requesting a stranger' do
